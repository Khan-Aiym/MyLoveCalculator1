...
import com.example.LoveCalculator.di.AppModule_ProvideApiFactory;
import com.example.LoveCalculator.di.AppModule_ProvidePreferencesFactory;
import com.example.LoveCalculator.repository.Repository;
import com.example.LoveCalculator.ui.HistoryFragment;
import com.example.LoveCalculator.ui.HomeFragment;
import com.example.LoveCalculator.ui.MainActivity;
import com.example.LoveCalculator.ui.MainActivity_MembersInjector;
import com.example.LoveCalculator.viewmodel.LoveViewModel;
import com.example.LoveCalculator.viewmodel.LoveViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(LoveViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private Provider<LoveViewModel> loveViewModelProvider;
    ...
    private Repository repository() {
      return new Repository(AppModule_ProvideApiFactory.provideApi(singletonCImpl.appModule));
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam,
        final ViewModelLifecycle viewModelLifecycleParam) {
      this.loveViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.LoveCalculator.viewmodel.LoveViewModel", ((Provider) loveViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.LoveCalculator.viewmodel.LoveViewModel 
          return (T) new LoveViewModel(viewModelCImpl.repository());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private void initialize(final AppModule appModuleParam,
      ...
      this.providePreferencesProvider = DoubleCheck.provider(new SwitchingProvider<SharedPreferences>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) AppModule_ProvidePreferencesFactory.providePreferences(singletonCImpl.appModule, ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
